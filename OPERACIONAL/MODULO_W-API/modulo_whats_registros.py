...
def gerenciar_banco_dados(dados_proc):
    ...
    try:
        ...
        nome_grupo = dados_proc.get('nome_grupo') # Novo campo recuperado
        ...
        # Define o valor para a coluna 'grupo': Se tiver nome, usa o nome, senão usa o ID como fallback
        ...
        cur.execute(sql_log, (
            ...
            valor_grupo_nome,             # * grupo (Nome do grupo ou ID se vazio)
            id_cliente_final,
            nome_cliente_final
        ))
...
def webhook():
    ...
    push_name = ""
    id_grupo = None
    nome_grupo = None # Inicializa variável
    ...
    if is_group:
        ...
        # Tenta capturar o nome do grupo do objeto chat
    ...
    dados_processados = {
        ...
        "is_group": is_group,
        "id_grupo": id_grupo,
        "nome_grupo": nome_grupo # Passa o nome capturado
    }
