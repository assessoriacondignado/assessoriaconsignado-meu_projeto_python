...
# Importações Opcionais (para evitar erro se o arquivo não existir)
try:
...
def app_pessoa_fisica():
    ...
    # CSS para ajustar altura dos botões e expansores
    st.markdown("""
        <style>
    ...
    # --- 5. TELA INICIAL (LISTA + MENU) ---
        ...
        if busca:
            ...
            if not df_lista.empty:
                ...
                # Layout padrão visual (igual pesquisa ampla)
                st.markdown("""
