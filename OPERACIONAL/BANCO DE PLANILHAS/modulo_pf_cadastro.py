...
CONFIG_CADASTRO = {
    ...
    "Endereços": [
        {"label": "CEP", "key": "cep", "tabela": "enderecos", "tipo": "cep", "multiplo": True, "agrupado": True}, # Agrupador
    ...
    with c_builder:
        ...
        with st.expander("Dados Pessoais", expanded=True):
            for campo in CONFIG_CADASTRO["Dados Pessoais"]:
                ...
                if campo['tipo'] == 'data':
                    val = st.date_input(campo['label'], value=None, format="DD/MM/YYYY", key=f"in_{campo['key']}")
